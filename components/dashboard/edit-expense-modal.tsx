...
export default function EditExpenseModal({ expense, onClose, onSuccess }: EditExpenseModalProps) {
  ...
  const [formData, setFormData] = useState({
    expenseNumber: expense.expenseNumber.toString(),
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="glass max-w-4xl w-full max-h-[90vh] overflow-y-auto relative border border-slate-300 dark:border-slate-600 shadow-2xl rounded-2xl backdrop-blur-xl bg-white dark:bg-slate-900"
        >
          {/* Close Button */}
          <motion.button
            onClick={onClose}
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg">Update your expense details</p>
          </motion.div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                {userProfile?.profileImage ? (
                  ...
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-700 flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
